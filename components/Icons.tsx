...
// A generic icon prop type to pass className and other SVG attributes
...
export const CakeIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 15.215V19a2 2 0 01-2 2H5a2 2 0 01-2-2v-3.785a2 2 0 01.488-1.297l1.393-1.857a2 2 0 00.488-1.297V3a2 2 0 012-2h8a2 2 0 012 2v5.776a2 2 0 00.488 1.297l1.393 1.857A2 2 0 0121 15.215z" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12a3 3 0 013-3h0a3 3 0 013 3v0M9 12h6" />
  </svg>
);
...
export const CompassIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.91 8.09 9.91 9.91l-1.82 6 6-1.82 1.82-6-6 1.82z" />
    </svg>
);
...
export const ChatAlt2Icon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 0 1-2.53-0.471l-5.459 2.729a.75.75 0 0 1-.962-.372l-2.01-4.02a.75.75 0 0 1 .372-.962l2.729-5.459A9.76 9.76 0 0 1 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25Z" />
    </svg>
);